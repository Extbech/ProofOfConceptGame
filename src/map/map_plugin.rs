...
pub enum TileSheetIndex {
    ...
    TopGrassTile = 1239,
    RightGrassTile = 1238,
    LeftDownGrassTile = 902,
    LeftTopGrassTile = 846,
    RightDownGrassTile = 903,
    RightTopGrassTile = 847,
    Bush = 1078,
}
                ...
                for y in 0..MAP_SIZE.1 {
                    ...
                    match tile_sheet_index {
                        TileSheetIndex::MiddleSandTile => {
                            // Check for bottom
                            //if x > 0 && get_ground_texture_index(map.get([x as f64 / PERLIN_SCALE_FACTOR, ]))
                        }
                        _ => continue,
                    }
                }
